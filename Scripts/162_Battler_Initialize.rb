class Battle::Battler
  ...
  def pbInitEffects(batonPass)
    ...
    @effects[PBEffects::SaltCure]           = -1
    @effects[PBEffects::SyrupBomb]           = 0
    @effects[PBEffects::RageFistHits]        = 0
    @effects[PBEffects::DoubleShock]         = false
    @effects[PBEffects::ElectromorphosisCharge] = false
    @effects[PBEffects::WindPowerCharge]     = false
    @effects[PBEffects::CudChewBerry]       = nil
    @effects[PBEffects::CudChewTriggerTurn]  = -1
    @effects[PBEffects::CudChewWasFling]     = false
    @effects[PBEffects::GlaiveRushVulnerable] = false
    @effects[PBEffects::HadStatLoweredThisBattle] = false
    @effects[PBEffects::RendBleed]           = 0
    @effects[PBEffects::HamstringLock]       = 0
