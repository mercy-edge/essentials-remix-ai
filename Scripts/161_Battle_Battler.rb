class Battle::Battler
  ...
  attr_accessor :canRestoreIceFace   # Whether snow (ice weather) was active when relevant this round
  ...
  def pbTypes(withExtraType = false)
    ...
    # Double Shock erases the Electric-type until switching out.
...
#      :FORECAST,                                          # This can be stopped
  ...
  def trappedInBattle?
    ...
    return true if @effects[PBEffects::HamstringLock] > 0
