...
class PokemonSystem
  ...
  # NPC hover tooltips (0=On, 1=Off). Old saves may omit @npc_hover_tooltip — treat as On.
  def npc_hover_tooltip
    return 0 if @npc_hover_tooltip.nil?

    @npc_hover_tooltip
  end

  def npc_hover_tooltip=(v)
    @npc_hover_tooltip = v
  end
  ...
  def initialize
    ...
    @npc_hover_tooltip = 0     # NPC mouseover name/level (0=On, 1=Off)
  end
end
...
MenuHandlers.add(:options_menu, :npc_hover_tooltip, {
  "name"        => _INTL("NPC Tooltips"),
  "order"       => 35,
  "type"        => EnumOption,
  "parameters"  => [_INTL("On"), _INTL("Off")],
  "description" => _INTL("Show name and level when the mouse hovers over overworld NPCs."),
  "get_proc"    => proc { next $PokemonSystem.npc_hover_tooltip },
  "set_proc"    => proc { |value, _scene| $PokemonSystem.npc_hover_tooltip = value }
})
