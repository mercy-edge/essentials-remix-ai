...
module Compiler
  ...
  def main
    ...
    begin
      ...
      # Timestamps can say "skip compile" while .dat files are truncated (crash mid-compile, sync, etc.)
      if !mustCompile
        bad_file = nil
        ...
        if bad_file
          Console.echoln_li(_INTL("Compiled data '{1}' could not be loaded (corrupt or incomplete). Recompiling.", bad_file))
          mustCompile = true
        end
      end
